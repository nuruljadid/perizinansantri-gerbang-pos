...
[wxID_FRAME1, wxID_FRAME1BTN_LOGIN, wxID_FRAME1PANEL1, wxID_FRAME1STATICTEXT1, 
 wxID_FRAME1STATICTEXT2, wxID_FRAME1TXT_PASSWORD, wxID_FRAME1TXT_USERNAME, 
...
class Frame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_FRAME1, name='', parent=prnt,
              pos=wx.Point(697, 314), size=wx.Size(342, 230),
              style=wx.DEFAULT_FRAME_STYLE, title=u'Halaman Login')
        self.SetClientSize(wx.Size(326, 192))
        self.Center(wx.HORIZONTAL)

        self.panel1 = wx.Panel(id=wxID_FRAME1PANEL1, name='panel1', parent=self,
              pos=wx.Point(0, 0), size=wx.Size(326, 192),
        ...
        self.txt_Username = wx.TextCtrl(id=wxID_FRAME1TXT_USERNAME,
              ...
              size=wx.Size(151, 23), style=wx.TE_PROCESS_ENTER, value=u'')
        ...
        self.txt_Password = wx.TextCtrl(id=wxID_FRAME1TXT_PASSWORD,
              ...
              size=wx.Size(152, 23), style=wx.TE_PASSWORD | wx.TE_PROCESS_ENTER,
              value=u'')
        ...
        self.btn_Login = wx.Button(id=wxID_FRAME1BTN_LOGIN, label=u'Login',
              name=u'btn_Login', parent=self.panel1, pos=wx.Point(128, 144),
